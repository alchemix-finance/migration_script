...
MAX_MINTS_PER_BATCH = 30            # Mint-specific cap to avoid out-of-gas / tx-size issues
MAX_DEPOSITS_PER_BATCH = 51         # Deposit-specific cap to avoid out-of-gas / tx-size issues
